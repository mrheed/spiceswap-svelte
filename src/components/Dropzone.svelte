<script>
  ...
  export let formatDesc = t('common.dropzone.format')
...
>
	...
	{:else}
		<div class="flex flex-col items-center justify-center">
			...
			<p class="mb-2 text-sm text-gray-500 dark:text-gray-4000">
				{@html t('common.dropzone.upload')}
			</p>
			<p class="text-xs text-gray-500 dark:text-gray-400">
				{t('common.dropzone.format')}
			</p>
		</div>
	{/if}
